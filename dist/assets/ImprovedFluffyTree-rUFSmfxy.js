import { C as Color, T as TextureLoader, a as ClampToEdgeWrapping, L as LinearFilter, A as AmbientLight, S as ShaderMaterial, D as DoubleSide, M as MeshBasicMaterial, G as GLTFLoader, b as Group, B as BufferAttribute, c as MeshStandardMaterial, d as ShadowMaterial, e as Mesh } from "./index-CGKHonim.js";
class ImprovedFoliageMaterial {
  constructor() {
    this.material = null;
    this.uniforms = {
      ...
      u_windSpeed: { value: 1 },
      u_windTime: { value: 0 },
      diffuse: { value: new Color(4353314) },
      opacity: { value: 1 },
      alphaMap: { value: null },
      // Add lighting uniforms
      ambientLightColor: { value: new Color(4210752) },
      ...
      textureLoader.load(
        ...
        (texture) => {
          ...
          const shaderMaterial = new ShaderMaterial({
            ...
            side: DoubleSide,
            transparent: false,
            // Using cutout approach
            alphaTest: 0.5,
            // Higher threshold for clean edges
            depthWrite: true
          });
...
class ImprovedFluffyTree {
  ...
  createShadowMesh(node) {
    ...
    this.shadowMesh = new Mesh(shadowGeometry, shadowMaterial);
